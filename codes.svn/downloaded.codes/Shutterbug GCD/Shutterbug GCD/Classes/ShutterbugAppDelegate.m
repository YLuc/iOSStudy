...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	PhotographersTableViewController *ptvc = [[PhotographersTableViewController alloc] initInManagedObjectContext:self.managedObjectContext];
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSString *modelPath = [[NSBundle mainBundle] pathForResource:@"Shutterbug" ofType:@"momd"];
